      ...
      <div className="form__container">
        <form onSubmit={handleSubmit} className="form" noValidate>
          ...
          <div className="form__radio">
            ...
            <div className="form__radio-btn">
              ...
              <label
                className={classNames("form__radio-btn", {
                  "checked": radio === "female",
                  "default": radio !== "female"
                })}
                htmlFor="radio-2"
              >
                <svg
                  className={classNames("icon", {
                    "checked1": radio === "female",
                    "default1": radio !== "female"
                  })}
                  width="20"
                  height="32"
                  viewBox="0 0 20 32"
            ...
            <div className="form__radio-btn">
              ...
              <label
                ...
                <svg
                  className={classNames("icon", {
                    "checked1": radio === "other",
                    "default1": radio !== "other"
                  })}
                  width="30"
                  height="32"
                  viewBox="0 0 30 32"
          ...
          <div className="form__inputs">
            ...
            <input
              className={classNames("form__input-p", {
                "form__input-err": errors.password,
                "form__input": !errors.password
              })}
          ...
          <div className="form__inputs">
            ...
            <input
              className={classNames({
                "form__input-err": errors.password2,
                "form__input": !errors.password2
              })}
            ...
            {errors.password2 && <p className="form__input-error">{errors.password2}</p>}
          </div>
